...
public class GroupManagementAdapter extends RecyclerView.Adapter<GroupManagementAdapter.GroupViewHolder<GrouplistItemBinding>> {
    ...
    public GroupManagementAdapter(Context context, GroupManagementViewModel groupManagementViewModel) {
